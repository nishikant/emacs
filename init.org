...
#+begin_src emacs-lisp
  ...
  (lsp-register-client
   (make-lsp-client :new-connection (lsp-stdio-connection
                    ...
                    :major-modes '(yaml-mode k8s-mode cfn-yaml-mode ansible docker docker-compose)
                    :priority 0
                    :server-id 'yamlls
...
#+begin_src emacs-lisp
  ...
  ;;         ("s" "sermon" plain #'org-roam-capture--get-point (file "~/org-roam/diary/gattu-template.txt") :file-name "%<%Y-%m-%d>_gattu_${slug}" :head "#+title: ${Title of the Message}\n#+ROAM_TAGS: Sermon\n#+DATE: %T\n#+VENUE: ${Venue}\n#+FORMAT: ${Format}\n#+STARTUP: showall\n#+DESCRIPTION: ${Main concept of service}\n#+OPTIONS: \\n:t\n" :unnarrowed t :immediate-finish t :jump-to-captured t)))
