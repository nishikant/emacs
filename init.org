...
- Installation command:
  ...
  brew reinstall emacs-head@28 --with-dbus --with-multicolor-fonts --with-mailutils --with-cocoa --with-imagemagick --with-xwidgets --with-ctags --with-modern-icon-purple --with-native-comp --with-native-full-aot --bottle-arch
- C-i is tab
